...
if (VULKANSDK_ROOT_DIR)
  ...
  set(_vk_lib_folder "lib")
  if (WIN32) 
    set(EXESUFFIX ".exe")
    #-------- Locate LIBS
    _find_files( VULKAN_LIB VULKANSDK_ROOT_DIR "${_vk_lib_folder}/vulkan-1.lib" "${_vk_lib_folder}/vulkan-1.lib" "")
    _find_files( VULKANSTATIC_LIB VULKANSDK_ROOT_DIR "${_vk_lib_folder}/VKstatic.1.lib" "${_vk_lib_folder}/VKstatic.1.lib" "")
  endif(WIN32)
